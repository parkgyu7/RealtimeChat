		...
		<form method="post" action="./userUpdate">
			<table class="table table-bordered table-hover" style="text-align:center;border:1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						<td style="width:110px;"><h5>PW check</h5></td>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userName" name="userName" maxlength="20" placeholder="이름" value="<%= user.getUserName() %>"></td>
					</tr>
					<tr>
						<td style="width:110px;"><h5>AGE</h5></td>
						<td colspan="2"><input class="form-control" type="number" id="userAge"name="userAge" maxlength="20" placeholder="나이" value="<%= user.getUserAge() %>"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="email" id="userEmail" name="userEmail" maxlength="20" placeholder="이메일" value = "<%= user.getUserEmail()%>"></td>
					</tr>
					<tr> <!-- 비밀번호 check message 칸  -->
