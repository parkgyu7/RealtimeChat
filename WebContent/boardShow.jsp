...
<body>
	...
	<div class= "container">
		<table class = "table table-bordered table-hover" style = "text-align:center; boarder:1px solide #dddddd">
			<thead>
				<tr>
				...
				<tr>
					<td style="background-color : #fafafa; color: #000000; width:80px;"><h5>작성날자</h5></td>
				...
				<tr>
					<td style="vertical-align: middle; min-height:150px; background-color : #fafafa; color: #000000; width:80px;"><h5>내 용</h5></td>
					<td colspan="3" style="text-align:left;"><h5><%= board.getBoardContent() %></h5></td>
				</tr>
				<tr>
					<td background-color : #fafafa; color: #000000; width:80px;"><h5>첨부파일</h5></td>
