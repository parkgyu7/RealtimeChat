	...
	<script type="text/javascript">
		...
		function addBox(lastID, toID, chatContent, chatTime, unread, profile){
			$('#boxTable').append('<tr onclick="location.href=\'chat.jsp?toID=' + encodeURIComponent(toID) + '\'">' +	
					...
					'<div class = "pull-right">' + chatTime + ' </div></td>' +
					'</tr>');
		}
	...
	<div class="container">
		<table class="table" style="margin:0 auto;">
			...
			<div style = "overflow-y: auto; width: 100%; max-height : 450px;">
				<table class="table table-bordered table-hover" style = "text-align:center; border : 1px solide #dddddd; margin: 0 auto;">
					<tbody id= "boxTable">
					</tbody>
				</table>
			</div>
